export default function SkeletonLoader() {
  return (
    <div className="w-full flex flex-col gap-8 animate-[fadeIn_0.3s_ease-out]">
      ...
      <div className="w-full rounded-2xl p-6 md:p-8 flex flex-col gap-6 md:gap-8 shadow-sm border border-stone-200 dark:border-white/5 bg-stone-50/50 dark:bg-stone-950/30">
        <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
          {/* Avatar Placeholder */}
          <div className="w-28 h-28 md:w-32 md:h-32 rounded-xl shimmer animate-shimmer flex-shrink-0"></div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 border-t border-stone-200 dark:border-white/5 pt-6">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="rounded-lg p-4 flex flex-col gap-2">
              <div className="w-12 h-12 rounded shimmer animate-shimmer"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-stone-200 dark:border-white/5 pt-6">
          {[1, 2, 3, 4].map((i) => (
      ...
      <div className="w-full rounded-2xl p-6 md:p-8 flex flex-col gap-4 shadow-sm border border-stone-200 dark:border-white/5 bg-stone-50/50 dark:bg-stone-950/30">
        <div className="w-40 h-6 rounded shimmer animate-shimmer"></div>
        <div className="w-full h-5 rounded-full shimmer animate-shimmer mt-2"></div>
      ...
      <div className="w-full flex flex-col gap-6">
        ...
        <div className="w-full flex flex-col sm:flex-row gap-4 items-center justify-between p-4 rounded-lg shadow-sm border border-stone-200 dark:border-white/5 bg-stone-50/50 dark:bg-stone-950/30">
          <div className="w-full sm:w-48 h-9 rounded shimmer animate-shimmer"></div>
          <div className="w-64 h-9 rounded shimmer animate-shimmer"></div>
        </div>

        {/* Cards Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="rounded-lg p-5 md:p-6 flex flex-col gap-4 shadow-sm border border-stone-200 dark:border-white/5 bg-stone-50/50 dark:bg-stone-950/30">
              <div className="flex justify-between items-center">
                <div className="w-36 h-6 rounded shimmer animate-shimmer"></div>
                <div className="w-12 h-4 rounded shimmer animate-shimmer"></div>
              </div>
              ...
              <div className="border-t border-stone-200 dark:border-white/5 pt-4 flex flex-col gap-3 mt-2">
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full shimmer animate-shimmer"></div>
                    <div className="w-16 h-3 rounded shimmer animate-shimmer"></div>
